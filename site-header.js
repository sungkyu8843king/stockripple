...
.toast{position:fixed;bottom:24px;right:24px;z-index:9999;background:var(--bg4);color:var(--text);border:1px solid var(--border-strong);border-radius:16px;padding:12px 16px;font-size:15.5px;display:flex;align-items:center;gap:8px;box-shadow:0 20px 50px rgba(0,0,0,.6);transform:translateY(80px);opacity:0;transition:all .2s;pointer-events:none;max-width:min(600px,calc(100vw - 48px));word-break:break-word}
@media (max-width:600px){ .toast{max-width:min(320px,calc(100vw - 48px))} }
