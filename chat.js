...
(function () {
  ...
  /* 접기/펼치기 버튼 — 원래는 작은 「«」버튼 + 옆에 뜨는 말풍선 힌트 조합이었는데,
     다른 레일 탭(채팅/실시간/관심/최근 본)과 생김새가 달라 헷갈린다는 피드백(2026-08) —
     아예 같은 탭 스타일(.srr-item)로 통일해서 아이콘+라벨("열기·닫기")을 늘 보여주는
     탭 하나로 합쳤다. 말풍선/애니메이션은 필요 없어져서 제거. */
  .srr-collapse{margin-bottom:8px}
