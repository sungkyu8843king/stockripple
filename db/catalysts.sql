...
VALUES
  ...
  -- ✅ 확정: 나스닥100 편입 발효 2026-07-07 (Seeking Alpha·CNBC·서울경제)
  ('US','SPCX','SpaceX','SpaceX 나스닥100 편입 (패시브 매수 유입)','편입', '2026-07-07', '7월 7일 (편입 발효)', 3,
   'Seeking Alpha·CNBC·서울경제 보도',
   '6/12 IPO(SPCX). 나스닥 룰 개정으로 fast-track 편입, 발효 7/7. 패시브 유입 추정 최대 ~41조원(복수지수 합산 $22~27B), 나스닥100 단독 J.P.모건 ~$4.3B', 'seed', 'seed:spacex-ndx100-2026')
